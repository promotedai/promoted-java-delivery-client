...
`insertionId` | String | Yes | Identifier for the Insertion.  It's always set on the Response Insertion (either generated by the SDK or API).  Do not set this on the Request Insertion unless Promoted has said otherwise.  If set on the Request Insertion, it might be passed back on the Response Insertion.  This is not guaranteed.
